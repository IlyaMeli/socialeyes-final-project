      ...
      <div className="post-content-wrapper">
        <div className="post-top">
          ...
          <div className="post-top-right">
            <MoreVertIcon className="post-more" onClick={()=>setModalShown(prevState => !prevState)}/>
            {modalShown&& <div className="post-edit-modal">
              <div className="post-edit-wrapper">
              <span className="post-edit-title">Edit Content:</span>
              <input className="post-edit-input" onChange={(e)=>{setEditValue(e.target.value)}}/>
              <button className="post-update-btn" onClick={update}>Update</button>
              </div>
              <CloseIcon className="post-close" onClick={()=>setModalShown(prevState => !prevState)}/>
            </div> }
            {error && <Alert severity="error" onClose={() => {setError(prevState => !prevState)}}>{error}</Alert>}
          </div>
        </div>
